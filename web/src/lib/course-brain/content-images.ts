...
export const contentImages: Record<string, ContentImage> = {
  ...
  "11b8ee9b-269a-49f1-b1c1-571951ce1e81": {
    src: "/content-images/ch2-p18-mediterranean-coast.jpg",
    alt: "Mediterranean rocky coastline with deep blue sea and pink oleander blossoms in the foreground",
    width: 525,
    height: 426,
    caption: "Mediterranean climate — chapter-2.pdf, p18",
    sourceFile: "chapter-2.pdf",
    pageOrSlide: 18,
  },
  "fc62a899-7a5c-4f04-b075-372d5c735849": {
    src: "/content-images/ch2-p20-marine-west-coast.jpg",
    alt: "Grassy clifftop above a sandy bay with rocky headlands, under low storm clouds",
    width: 182,
    height: 155,
    caption: "Marine west coast climate — chapter-2.pdf, p20",
    sourceFile: "chapter-2.pdf",
    pageOrSlide: 20,
  },
  "856b9788-22cc-4435-9231-654443412c72": {
    src: "/content-images/ch2-p20-ne-us-satellite.jpg",
    alt: "Satellite photo of the North East U.S. coastline, showing forested land, bays, and the Atlantic Ocean",
    width: 182,
    height: 155,
    caption: "Humid continental climate (North East U.S.) — chapter-2.pdf, p20",
    sourceFile: "chapter-2.pdf",
    pageOrSlide: 20,
  },
};
