...
export const contentImages: Record<string, ContentImage> = {
  ...
  "f1012de4-075c-4ab5-a441-1cfb3a871732": {
    ...
    alt: "Autumn deciduous forest with vivid orange and red canopy beside a blue lake",
    width: 170,
    height: 96,
    caption: "Deciduous forest — chapter-2.pdf, p19",
    sourceFile: "chapter-2.pdf",
    pageOrSlide: 19,
  },
  "597fd168-ea69-4012-be79-c730070b952f": {
    src: "/content-images/ch2-p19-evergreen-forest.jpg",
    alt: "Young evergreen conifers in rows in a green grassy field, pale blue sky behind",
    width: 183,
    height: 133,
    caption: "Evergreen forest — chapter-2.pdf, p19",
    sourceFile: "chapter-2.pdf",
    pageOrSlide: 19,
  },
  "6e94cafe-6b33-451f-9f77-a41ce89f09e5": {
    src: "/content-images/ch2-p21-subarctic-map.png",
    alt: "Greyscale distribution map of North America with the subarctic climate belt filled dark grey, from Alaska across northern Canada to Labrador",
    width: 218,
    height: 275,
    caption: "Subarctic climate distribution — chapter-2.pdf, p21",
    sourceFile: "chapter-2.pdf",
    pageOrSlide: 21,
  },
  "e6f73628-6399-476a-aa9e-75fd75b98944": {
    src: "/content-images/ch2-p22-tundra.png",
    alt: "Vast flat snow-covered tundra plain under a low sun near the horizon, pale blue-to-apricot sky",
    width: 225,
    height: 165,
    caption: "Tundra climate — chapter-2.pdf, p22",
    sourceFile: "chapter-2.pdf",
    pageOrSlide: 22,
  },
  "7327549a-dc74-470d-9274-80fdfc13506b": {
    src: "/content-images/ch2-p22-icecap.png",
    alt: "Satellite view of Earth's polar ice cap from above the North Pole, brilliant white ice sheet against a black space background",
    width: 225,
    height: 195,
    caption: "Ice cap climate — chapter-2.pdf, p22",
    sourceFile: "chapter-2.pdf",
    pageOrSlide: 22,
  },
  "7bc6947d-0d4c-441a-817c-77284ad40069": {
    src: "/content-images/ch2-p23-highland.png",
    alt: "Highland mountain landscape with bare rocky peaks above green vegetated slopes and a shallow reed-fringed lake in the foreground",
    width: 218,
    height: 190,
    caption: "Highland climate — chapter-2.pdf, p23",
    sourceFile: "chapter-2.pdf",
    pageOrSlide: 23,
  },
