...
**Split results so far** (2026-08-08/09, all 4 chapters fully audited): DB grew from 66 → 111 published content_units. Per-chapter counts: chapter-1-candidate-a.pdf 35, chapter-2.pdf 35, chapter-3.pdf 9, chapter-4.pdf 32. Known remaining gap (not a merge issue, just missing): chapter-2.pdf p19 names three forest types (Deciduous, Evergreen, Mixed) under the Humid Subtropical climate that have no content_unit at all yet.
